    ...
    return (
      <div id="tinTuc">
        <section className="readmore">
          <div className="container readmore__content pt-20">
            <ul
                ...
                <div className="container">
                  ...
                  <div className="row " id="r__hidden">
                    ...
                    <div className="col-md-6 readmore__img">
                      ...
                      <p className="icon pl-1">
                        <i className="fa fa-thumbs-up" /> &nbsp; 15 &nbsp;
                        <i className="fa fa-comments" />
                        1
                      </p>
                    </div>
                ...
                <div className="container">
                  <div className="row">
                    <div className="col-md-6 readmore__img">
                      ...
                      <p className="icon pl-1">
                        <i className="fa fa-thumbs-up" /> &nbsp; 32 &nbsp;
                        <i className="fa fa-comments" />
                        6
                      </p>
                    </div>
                    <div className="col-md-6 readmore__img">
                      ...
                      <p className="icon pl-1">
                        <i className="fa fa-thumbs-up" /> &nbsp; 19 &nbsp;
                        <i className="fa fa-comments" />
                        5
                      </p>
                    </div>
                  ...
                  <div className="row">
                    <div className="col-md-4 readmore__img readmore__bot">
                      ...
                      <p className="icon pl-1">
                        <i className="fa fa-thumbs-up" /> &nbsp; 12 &nbsp;
                        <i className="fa fa-comments" />
                        2
                      </p>
                    </div>
                  ...
                  <div className="row " id="r__hidden1">
                    <div className="col-md-6 readmore__img">
                      ...
                      <p className="icon pl-1">
                        <i className="fa fa-thumbs-up" /> &nbsp; 25 &nbsp;
                        <i className="fa fa-comments" />
                        1
                      </p>
                    </div>
                    <div className="col-md-6 readmore__img">
                      ...
                      <p className="icon pl-1">
                        <i className="fa fa-thumbs-up" /> &nbsp; 17 &nbsp;
                        <i className="fa fa-comments" />
                        4
                      </p>
                    </div>
                ...
                <div className="container">
                  ...
                  <div className="row" id="r__hidden2">
                    <div className="col-md-6 readmore__img">
                      ...
                      <p className="icon pl-1">
                        <i className="fa fa-thumbs-up" /> &nbsp; 26 &nbsp;
                        <i className="fa fa-comments" />
                        8
                      </p>
                    </div>
